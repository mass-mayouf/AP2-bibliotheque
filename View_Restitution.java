...
public class View_Restitution {
    ...
    private void initialize() throws SQLException, ClassNotFoundException {
        ...
        styleButton(btnRestituer);
        btnRestituer.setBounds(500, 350, 150, 40);
        ...
        btnValider.addActionListener(e -> {
            try {
                ...
                if (ad != null) {
                    ...
                    // que les livres empruntés par cet adhérent
                    ...
                    btnRestituer.addActionListener(ev -> {
                        ...
                        if (selectedRow != -1) {
                            ...
                            try {
                                ...
                                JOptionPane.showMessageDialog(frame, "Livre restitué !");
                            } catch (Exception ex) {
                                ex.printStackTrace();
                            }
                        }
                    ...
                    JOptionPane.showMessageDialog(frame, "Aucun adhérent trouvé pour ce numéro !");
                }
            } catch (Exception ex) {
                ex.printStackTrace();
            }
